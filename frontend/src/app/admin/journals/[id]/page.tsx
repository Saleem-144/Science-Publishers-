...
export default function EditJournalPage() {
  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-8 border-b pb-4">Edit Journal: {formData.title}</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <div className="xl:col-span-8 space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <EditorialBoardManager journalId={parseInt(journalId)} />
          </div>
                ...
                onChange={(e) => setFormData({ ...formData, editor_in_chief: e.target.value })}
                  ...
                  <div className="relative group">
                    <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-gray-200 bg-white">
                      {(editorImagePreview || existingEditorImage) ? (
                        <Image
                          src={editorImagePreview || existingEditorImage!}
                          alt="Editor Avatar"
                          fill
                          className="object-cover"
                        />
                  ...
                  {(flyerFile || existingFlyer) && (
                    <div className="flex items-center justify-between p-3 bg-blue-50 border border-blue-100 rounded-xl">
                      ...
                      {existingFlyer && !flyerFile && (
                        <a href={existingFlyer} target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-blue-600 hover:underline">View</a>
                      )}
                    </div>
                  )}
                </div>
